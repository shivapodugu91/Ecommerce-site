...
namespace Admin
{
    public partial class AdminReturn_Initiate : System.Web.UI.Page
    {
        ...
        /*  public void check_return(object sender, EventArgs e)
          {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                // MySqlDataAdapter oda = new MySqlDataAdapter("select * from mydb.lineitems where Shipment_status='RETURN INITIATED' ;", connection);
                MySqlDataAdapter oda = new MySqlDataAdapter("select l.Order_id,l.LineItems_id,l.Shipment_status,p.Product_name,p.Product_desc,l.Product_price from mydb.order_lineitems l,mydb.product p where p.Product_id=l.Product_id and Shipment_status='RETURN INITIATED' ;", connection);
        ...
        public void gv1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            if (this.IsPostBack)
            {
                ...
                try
                {
                    ...
                    if (Shipment_status == "RETURN RECEIVED")
                    {
                        ...
                        //SqlCommand1 = new MySqlCommand("Update mydb.order set TotalPrice=TotalPrice-(select Product_price from mydb.product where Product_id=(select Product_id from mydb.order_lineitems where LineItems_id=" + LineItems_id + " and Order_id=" + Order_id + ")) where Order_id=" + Order_id + ";", connection);
