<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pick_status.aspx.cs" Inherits="Admin.Pick_status" %>
    ...
    <asp:GridView ID="gv1" runat="server" AutoGenerateColumns ="False"
       ...
       <asp:TemplateField HeaderText="Order_id">
        ...
        <EditItemTemplate >
         ...
         <%--<asp:Button ID="btnGetSelected" runat="server" Text="PACK" OnClick="GetSelectedRecords" />--%>

        <div class="control-group">
            <div class="controls">
              <asp:Button ID="btnGetSelected" class="btn btn-large btn-success"  runat="server" Text="PACK" OnClick="GetSelectedRecords"/>
            </div>
          </div>
