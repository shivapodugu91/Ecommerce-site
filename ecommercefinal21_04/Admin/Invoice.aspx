<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="Admin.Invoice" %>
    ...
    <div>
       ...
       <asp:TemplateField HeaderText="Order_id">
        ...
        <EditItemTemplate >
         ...
         <asp:Button ID="btnGetSelected" runat="server" Text="SHIP" OnClick="GetSelectedRecords" />
