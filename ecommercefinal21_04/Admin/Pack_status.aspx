<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pack_status.aspx.cs" Inherits="Admin.Pack_status" %>
    ...
    <div>
       ...
       <asp:TemplateField HeaderText="Order_id">
        ...
        <EditItemTemplate >
         ...
         <asp:Button ID="btnGetSelected" runat="server" Text="INVOICE" OnClick="GetSelectedRecords" />


        <div class="co<asp:Button ID="adminhome" class="btn btn-large btn-success"  runat="server" Text="Go to status" OnClick="adminhome_Click" style="height: 26px"/>
            ntrol-group">
            <div class="controls">
            </div>
          </div>
