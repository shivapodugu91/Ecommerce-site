...
namespace Admin
{
    public partial class Pick_status : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            ...
            try
            {
                ...
                MySqlDataAdapter oda = new MySqlDataAdapter("select Order_id,LineItems_id,Shipment_status from mydb.order_lineitems where Shipment_status in('PICK') ;", connection);
            ...
            foreach (GridViewRow row in gv1.Rows)
            {
                ...
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkRow.Checked)
                    {
                        ...
                        SqlCommand = new MySqlCommand("update mydb.order_lineitems set Shipment_status='PACK' where LineItems_id=" + LineItems_id, connection);
