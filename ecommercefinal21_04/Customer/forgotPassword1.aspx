<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotPassword1.aspx.cs" Inherits="ecomNew.forgotPassword1" %>
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <input type="submit" id="submitButton"  class="btn btn-primary" value="Go"></input>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">
		<div class="span9" style="min-height:900px">
			<div class="well">
			<h5>Please answer the following</h5><br/>

                <form id="form1" runat="server">
			<asp:Label ID="ques1" runat="server" ></asp:Label><br/><br/><br/>
                    <asp:TextBox ID="ans1" runat="server"></asp:TextBox><br/><br/><br/>
			
			  <asp:Label ID="ques2" runat="server" ></asp:Label><br/><br/><br/>
                    <asp:TextBox ID="ans2" runat="server"></asp:TextBox>
			  </div>
			  <div class="controls">
			  <asp:Button ID="sub" type="submit" runat="server" class="btn block" Text="Submit" OnClick="sub_Click"></asp:Button>
			  </div>
