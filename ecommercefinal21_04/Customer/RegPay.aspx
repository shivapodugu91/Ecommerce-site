<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegPay.aspx.cs" Inherits="Customer.RegPay" %>
	...
	<div class="row-fluid">
      <form class="form-horizontal" id="form1" runat="server">
        <fieldset>
          ...
          <div class="control-group">
            <div class="controls">
              <asp:Button ID="registerbtn" class="btn btn-large btn-success"  runat="server" Text="PAY NOW" OnClick="registerbtn_Click" />
            </div>
          </div>
