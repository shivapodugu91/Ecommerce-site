<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Addresses.aspx.cs" Inherits="ecomNew.Addresses" %>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <div class="alert alert-block alert-error fade in">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <asp:TextBox id="baddress" runat="server" placeholder="Adress"/> <span>Street address, P.O. box, company name, c/o</span>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="baddress" ErrorMessage="Address Required"  CssClass="text-danger" Display="Dynamic">*Address Required</asp:RequiredFieldValidator>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <asp:TextBox id="baddress2" runat="server" placeholder="Adress line 2"/> <span>Apartment, suite, unit, building, floor, etc.</span>

                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="baddress2" ErrorMessage="Address Required"  CssClass="text-danger" Display="Dynamic">*Address Required</asp:RequiredFieldValidator>
		...
		<div class="control-group">
			...
			<div class="controls">
			  <asp:TextBox id="bcity" runat="server" placeholder="city"/> 
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="bcity" ErrorMessage="City Required"  CssClass="text-danger" Display="Dynamic">*Address Required</asp:RequiredFieldValidator>
			</div>
		</div>
		<div class="control-group">
			<asp:Label class="control-label" runat="server" for="state">State<sup>*</sup></asp:Label>
			<div class="controls">
			  &nbsp;<asp:TextBox ID="bstate" placeholder="State" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="bstate" ErrorMessage="State Required"  CssClass="text-danger" Display="Dynamic">*State Required</asp:RequiredFieldValidator>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
			&nbsp;<asp:TextBox ID="bcountry" placeholder="Country" runat="server"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="bcountry" ErrorMessage="Country Required"  CssClass="text-danger" Display="Dynamic">*Country Required</asp:RequiredFieldValidator>
			</div>
        ...
        <div class="control-group">
			...
			<div class="controls">
			  <asp:TextBox id="bpostcode" runat="server" placeholder="Zip / Postal Code"/> 
                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="bpostcode" ErrorMessage="Postalcode Required"  CssClass="text-danger" Display="Dynamic">*Postcode Required</asp:RequiredFieldValidator> 
	...
	<div class="control-group">
			<div class="controls">
				...
				<asp:Button ID="registerbtn" class="btn btn-large btn-success"  runat="server" Text="Register" OnClick="registerbtn_Click" />
			</div>
		</div>		
	    </form>
</div>
...
<!-- Footer ================================================================== -->
	...
	<div class="container">
		<div class="row">
			<div class="span3">
				<h5>ACCOUNT</h5>
				<a href="UpdateRegistration.aspx?userid=<%= Session["userid"].ToString()%>">YOUR ACCOUNT</a>
			<%--	<a href="login.aspx?userid=<%= Session["userid"].ToString()%>" >PERSONAL INFORMATION</a>--%> 
