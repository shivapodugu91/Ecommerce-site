<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="products.aspx.cs" Inherits="ecomNew.products" %>
  ...
  <div class="navbar-inner">
	...
	<div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
		  <div class="modal-header">
			<asp:Button type="button" runat="server" class="close" data-dismiss="modal" aria-hidden="true" Text="�"></asp:Button>
			<%--<h3>Login Block</h3>--%>
		  </div>
		  <div class="modal-body">
			...
			<asp:Button runat="server" class="btn" data-dismiss="modal" aria-hidden="true" Text="Close"></asp:Button>
		  </div>
	</div>
	</li>
    </ul>
...
<div class="tab-content">
	<div class="tab-pane" id="listView">
		<div class="row">	  
			...
			<h3> $140.00</h3>
			<asp:Label runat="server" class="checkbox">
				<asp:CheckBox runat="server" Text=" Adds product to compare"/> 
			</asp:Label><br/>
	...
	<a href="compair.aspx" class="btn btn-large pull-right">Compare Product</a>
