<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerAddress.aspx.cs" Inherits="Customer.CustomerAddress" %>
...
<!-- Sidebar end=============================================== -->
	...
	<%--<div class="alert alert-block alert-error fade in">
        ...
        <div class="control-group">
            ...
            <div class="control-group">
                <div class="controls">
                    <asp:RadioButton runat="server"  ID="yes" GroupName="a" OnCheckedChanged="yes_CheckedChanged" AutoPostBack="true"/>
                    <asp:Label Text="YES" runat="server">
                    </asp:Label>
                </div>

                <div class="controls">
                    <asp:RadioButton runat="server"  ID="No" GroupName="a" AutoPostBack="true" OnCheckedChanged="yes_CheckedChanged"/>
	...
	<div class="control-group">
			<div class="controls">
				...
				<asp:Button ID="Proceed" class="btn btn-large btn-success"  runat="server" Text="Proceed to pay" OnClick="Proceed_Click"/>
			</div>
		</div>		
