<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="ecomNew.ChangePassword" %>
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <input type="button" id="submitButton"  class="btn btn-primary" value="Go"/>
  
    <ul id="topMenu" class="nav pull-right">
	<%-- <li class=""><a href="special_offer.aspx">Special Offer</a></li>
	...
	<div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
		  ...
		  <div class="modal-body">
			<%--<form class="form-horizontal loginFrm">
			  ...
			  <div class="control-group">
				<asp:TextBox type="password" id="inputPassword" runat="server" placeholder="Password"/>
			  </div>
			  <div class="control-group">
			...
			<%--<asp:Button runat="server" class="btn btn-success" Text="Sign in"></asp:Button>
			<asp:Button class="btn" data-dismiss="modal" runat="server"
               aria-hidden="true" Text="Close"></asp:Button>--%>
		  </div>
	</div>
	</li>
    </ul>
	...
	<div class="row">
		<div class="span9" style="min-height:900px">
			...
			<form id="form1" runat="server">
			  <div class="control-group">
				<asp:Label class="control-label" runat="server" for="OldPassword">Old Password</asp:Label>
				<div class="controls">
				  <asp:TextBox class="span3"  type="text" id="OldPassword" runat="server" placeholder="Old Password"/>
				</div>
			  </div>
                <div class="control-group">
				<asp:Label class="control-label" runat="server" for="NewPassword">NewPassword</asp:Label>
				<div class="controls">
				  <asp:TextBox class="span3"  type="password" id="NewPassword" runat="server" placeholder="New Password"/>
				<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="NewPassword" Display="Dynamic" ErrorMessage="RegularExpressionValidator"  CssClass="text-error" SetFocusOnError="True" ValidationExpression="^.*(?=.{8,})(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!*@#$%^&amp;+=]).*$" ValidationGroup="all"> * At least one lower case letter,
            At least one upper case letter,At least special character,At least one number,At least 8 characters length</asp:RegularExpressionValidator>
                ...
                <div class="control-group">
				<asp:Label class="control-label" runat="server" for="ConfirmNewPassword">Confirm Password</asp:Label>
				<div class="controls">
				  <asp:TextBox class="span3"  type="password" id="ConfirmNewPassword" runat="server" placeholder="Confirm Password"/>
				<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="ConfirmNewPassword" Display="Dynamic" ErrorMessage="RegularExpressionValidator"  CssClass="text-error" SetFocusOnError="True" ValidationExpression="^.*(?=.{8,})(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!*@#$%^&amp;+=]).*$" ValidationGroup="all"> * At least one lower case letter,
            At least one upper case letter,At least special character,At least one number,At least 8 characters length</asp:RegularExpressionValidator>
                </div>
			  </div>
			  <div class="controls">
			  <asp:Button ID="subclick" type="submit" runat="server" class="btn block" Text="Submit" OnClick="subclick_Click"></asp:Button>
			  </div>
			</form>
		</div>
		</div>
