<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="ecomNew.contact" %>
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <asp:Button runat="server" type="submit" id="submitButton" class="btn btn-primary" Text="Go"></asp:Button>
	...
	<div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false" >
		  <div class="modal-header">
			<asp:Button type="button" class="close" data-dismiss="modal" aria-hidden="true" runat="server" Text="×"></asp:Button>
			<h3>Login Block</h3>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal loginFrm">
			  <div class="control-group">								
				<asp:TextBox runat="server" id="inputEmail" placeholder="Email"/>
			  </div>
			  <div class="control-group">
			...
			<asp:Button type="submit" runat="server" class="btn btn-success" Text="Sign in"></asp:Button>
	...
	<div class="row">
        ...
        <fieldset>
          <div class="control-group">
              ...
              <asp:TextBox runat="server" placeholder="name" class="input-xlarge"/>
           
          </div>
		   <div class="control-group">
           
              <asp:TextBox runat="server" placeholder="email" class="input-xlarge"/>
           
          </div>
		   <div class="control-group">
           
              <asp:TextBox runat="server" placeholder="subject" class="input-xlarge"/>
          ...
          <div class="control-group">
            ...
            <asp:Button runat="server" class="btn btn-large" Text="Send Messages" type="submit"></asp:Button>
