<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateRegistration.aspx.cs" Inherits="ecomNew.UpdateRegistration" %>
...
<div id="welcomeLine" class="row">
	<div class="span6"><strong><asp:Label ID="labelusername" runat="server"></asp:Label> </strong></div>
	<div class="span6">
	<div class="pull-right">
		...
		<a href="product_summary.aspx"><span class="btn btn-mini btn-primary"><i class="icon-shopping-cart icon-white"></i>  Items in your cart </span> </a> 
	</div>
	</div>
</div>
<!-- Navbar ================================================== -->
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <input type="button" id="submitButton" runat="server" class="btn btn-primary" value="Go"/>
    ...
    <ul id="topMenu" class="nav pull-right">
	 ...
	 <li class="">
	 <%--<asp:Button ID="homebtn" runat="server" data-toggle="modal" class="btn btn-large btn-success" style="padding-right:0" Text="Home" ></asp:Button>--%>
...
<!-- Sidebar end=============================================== -->
	...
	<div class="alert fade in">
	 ...
	 <div class="alert alert-block alert-error fade in">
		...
		<div class="control-group">
			...
			<div class="controls">
			  <asp:TextBox id="inputFname1" runat="server" placeholder="First Name"/>
		...
		<div class="controls">
		  <asp:TextBox id="input_email" runat="server" placeholder="Email"  />

            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="input_email" Enabled="false"  ErrorMessage="Emailid Required"  CssClass="text-danger" Display="Dynamic">*Emailid Required</asp:RequiredFieldValidator>
            ...
            <div class="control-group">
		<asp:Label class="control-label" runat="server" for="mobile">Telephone Number <sup>*</sup></asp:Label>
            <div class="controls">
		  <asp:TextBox id="mobile" runat="server" placeholder="Mobile"  />

            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="mobile" Enabled="false"  ErrorMessage="Emailid Required"  CssClass="text-danger" Display="Dynamic">*Emailid Required</asp:RequiredFieldValidator>
             <asp:RegularExpressionValidator runat="server" ControlToValidate="mobile" ValidationExpression="^\d{10}$" ErrorMessage="Mobile Number must be a 10-digit number" CssClass="text-danger">*Mobile number must be a 10-digit number</asp:RegularExpressionValidator>
		</div>
	...
	<div class="control-group">
            ...
            <br />
            <br />
                        				<asp:Button ID="update" class="btn btn-large btn-success"  runat="server" Text="Update" OnClick="update_Click" />
