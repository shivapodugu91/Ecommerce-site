<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_details.aspx.cs" Inherits="ecomNew.product_details" %>
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <asp:Button type="submit" id="submitButton" runat="server" class="btn btn-primary" Text="Go"></asp:Button>
	...
	<div class="row">	  
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<asp:Label runat="server" class="control-label"><span>$222.00</span></asp:Label>
					<div class="controls">
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="blockView">
				<ul class="thumbnails">
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.aspx"><img src="../themes/images/products/12.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
					...
					<li class="span3">
					  <div class="thumbnail">
						<a href="product_details.aspx"><img src="../themes/images/products/13.jpg" alt=""/></a>
						<div class="caption">
						  <h5>Manicure &amp; Pedicure</h5>
						  <p> 
							Lorem Ipsum is simply dummy text. 
