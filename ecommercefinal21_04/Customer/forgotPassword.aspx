<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgotPassword.aspx.cs" Inherits="ecomNew.forgotPassword" %>
  ...
  <div class="navbar-inner">
    <a class="brand" href="index.aspx"><img src="../themes/images/logo.png" alt="Bootsshop"/></a>
		...
		<input id="srchFld" class="srchTxt" type="text" />
		  ...
		  <input type="button" id="submitButton"  class="btn btn-primary" value="Go"></input>
	...
	<div class="row">
		<div class="span9" style="min-height:900px">
			...
			<form id="form1" runat="server">
			  <div class="control-group">
				<asp:Label class="control-label" runat="server" for="input_email">E-mail address</asp:Label>
				<div class="controls">
				  <asp:TextBox class="span3"  type="text" id="input_email" runat="server" placeholder="Email" OnTextChanged="input_email_TextChanged"  AutoPostBack="true"/><asp:Label ID="Label1" CssClass="text-error" runat="server" ></asp:Label>
				</div>
			  </div>
			  <div class="controls">
			  <asp:Button ID="sub1" type="submit" runat="server" class="btn block" Text="Submit" OnClick="sub1_Click"></asp:Button>
			  </div>
			</form>
		</div>
		</div>
